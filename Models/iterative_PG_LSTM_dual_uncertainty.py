...
def createModel(
    ...
    for layer in np.arange(n_layer_temp):
        model.add(Dense(n_nodes, use_bias=1,kernel_regularizer=regularizers.l1_l2(l1=lamda_reg,l2=lamda_reg)))
...
def compute_percent_z_score(mean,std,test_y):
    ...
    #Start of function
def PG_LSTM_train_test(iteration, tr_frac, val_frac, patience_val, num_epochs, batch_size, lstm_nodes, feedforward_nodes, mask_value, drop_frac, lstm_bias, 
                            n_nodes, use_GLM, use_temporal_feature, lamda_reg, shuffle, tol, pad_steps, n_layer_temp, n_layer_density, lamda_phy, hold_out_frac=0.1):
    ...
    results_dir = '/home/karpatne/Documents/Lake Temperature Modelling/Results/SDM_results/PG_LSTM_dual/'
    ...
    val_hold_y_temperature = masking_output_labels(val_hold_y_temperature,mask_value)
    ...
    [val_hold_X_pad, val_hold_y_temperature_pad]=edge_padding(val_hold_X, val_hold_y_temperature, pad_steps);
...
if __name__ == '__main__':     
    ...
    for iteration in np.arange(iter):
        for tr_frac in tr_frac_range:
            PG_LSTM_train_test(iteration, tr_frac, val_frac, patience_val, num_epochs, batch_size, lstm_nodes, feedforward_nodes, mask_value, drop_frac, lstm_bias, 
